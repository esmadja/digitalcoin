...
uint256 hashGenesisBlock("0x34bbf350c1a09bd6fc6acce64cd4fb9c5204ebe31b16f6eff0be95339cd7ab17");
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xe28d5412d9a235f1ec2bcaf305ba967c3d5fd80272547998e34802ec19204221");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1392499236; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1468222;

        if (fTestNet)
        {
            block.nTime    = 1391984252;
            block.nNonce   = 440824;
        }
